      ...
      <div className="about-container">
        <div className="hero-text">
          ...
          <div className="about-text">
            <p>
              This website was created with the intent of getting the services
              you need just one click away. After creating your profile, you can
                  ...
                  <div className="user-text">
                    ...
                    <div className="links">
                      <div className="link">
                        <a
                          target="_blank"
                          href="https://github.com/jdeering94"
                          rel="noreferrer"
                        >
                          <img
                            src={githubLogo}
                  ...
                  <div className="user-text">
                    ...
                    <div className="links">
                      <div className="link">
                        <a
                          target="_blank"
                          href="https://github.com/frozenborder72"
                          rel="noreferrer"
                        >
                          <img
                            src={githubLogo}
